...
1. Gift & Deza. *Practical MLOps*. O'Reilly, 2021.
2. Kohavi, Tang, Xu. *Trustworthy Online Controlled Experiments: A Practical Guide to A/B Testing*.
3. Géron. *Hands-on Machine Learning with Scikit-Learn, Keras, and TensorFlow*. O'Reilly, 2022.
4. [Stanford CS 329S](https://stanford-cs329s.github.io/syllabus.html)
