...
**Note:** The grading policy below is **tentative** and will be finalized before the first day of lectures. Any updates will be communicated through the course Slack channel.
:::

| **Component** | **Weight** | **Details** |
|---------------|------------|-------------|
| **Lab Assignments + Viva** | **48%** | 4-5 hands-on assignments with viva voce (group size: TBD) |
| **Quizzes** | **42%** | Best 3 out of 4 quizzes (14% each) |
| **Attendance** | **10%** | See breakdown below |
...
- **Labs + Viva:** Practical, hands-on work with real tools (Docker, MLFlow, Weights & Biases, etc.) evaluated through submission and oral discussion
- **Quizzes:** Flexible grading—your lowest quiz score is automatically dropped
- **Attendance:** Graded based on number of absences (see table above)
